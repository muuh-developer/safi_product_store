        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bold ms-2">safi store</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active open">
              ...
              <ul class="menu-sub">
                <li class="menu-item active">
                  <a href="{{url('product/home')}}" class="menu-link">
                    <div class="text-truncate" data-i18n="Analytics">Products</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a
                    href="{{url('category/add')}}"
                    class="menu-link">
                    <div class="text-truncate" data-i18n="CRM">category</div>
                ...
                <li class="menu-item">
                  <a
                    ...
                    target="_blank"
                    class="menu-link">
                    <div class="text-truncate" data-i18n="eCommerce">Trending</div>
                    <div class="badge rounded-pill bg-label-primary text-uppercase fs-tiny ms-auto">Pro</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a
                    ...
                    target="_blank"
                    class="menu-link">
                    <div class="text-truncate" data-i18n="Logistics">stock</div>
                    <div class="badge rounded-pill bg-label-primary text-uppercase fs-tiny ms-auto">Pro</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="app-academy-dashboard.html" target="_blank" class="menu-link">
                    <div class="text-truncate" data-i18n="Academy">statistics</div>
                    <div class="badge rounded-pill bg-label-primary text-uppercase fs-tiny ms-auto">Pro</div>
                  </a>
                </li>
              </ul>
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div class="text-truncate" data-i18n="Front Pages">sales</div>
                <div class="badge rounded-pill bg-label-primary text-uppercase fs-tiny ms-auto">Pro</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a
                    ...
                    class="menu-link"
                    target="_blank">
                    <div class="text-truncate" data-i18n="Landing">Over view</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a
                    ...
                    class="menu-link"
                    target="_blank">
                    <div class="text-truncate" data-i18n="Pricing">Invoices</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a
                    ...
                    class="menu-link"
                    target="_blank">
                    <div class="text-truncate" data-i18n="Payment">Payments</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a
                    ...
                    class="menu-link"
                    target="_blank">
                    <div class="text-truncate" data-i18n="Checkout">Analysis</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="menu-item">
              <a
                ...
                <div class="text-truncate" data-i18n="Calendar">Calender and plans</div>
                <div class="badge rounded-pill bg-label-primary text-uppercase fs-tiny ms-auto">Pro</div>
              </a>
            </li>
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div class="text-truncate" data-i18n="Account Settings">Stakeholders</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div class="text-truncate" data-i18n="Authentications"> profile</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="auth-login-basic.html" class="menu-link" target="_blank">
                    <div class="text-truncate" data-i18n="Basic">manage profile</div>
                  </a>
                </li>

        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li class="scroll-to-section"><div class="main-red-button"><a href="{{url('/signUp')}}">sign up</a></div></li> 
            </ul>        
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="right-image wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                <img src="assets/images/muuh.jpg" alt="team meeting" class="rounded-pill">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
          <div class="section-heading  wow bounceIn" data-wow-duration="1s" data-wow-delay="0.2s">
            <h2>See What Our Agency <em>services</em> &amp; What We <span>Provide</span></h2>
          </div>
        </div>
      </div>
      <div class="row">
          ...
          <a href="#">
            <div class="item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.3s">
              <div class="hidden-content">
                <h4>Afya Drinking water</h4>
                <p>pure drinking water from water com limited</p>
              </div>
              <div class="showed-content">
                <img src="/images/afyaWater.jpeg" alt="">
              </div>
            </div>
          </a>
        </div>
        <div class="col-lg-3 col-sm-6">
          <a href="#">
            <div class="item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.4s">
              <div class="hidden-content">
                <h4>Azam energy</h4>
                <p>Enjoy  product from bakressa group of companay</p>
              </div>
              <div class="showed-content">
                <img src="images/azamfruit.jpeg" alt="">
              </div>
            </div>
          </a>
        </div>
        <div class="col-lg-3 col-sm-6">
          <a href="#">
            <div class="item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.5s">
              <div class="hidden-content">
                <h4>Omo</h4>
                <p>best washing soap for white clothers</p>
              </div>
              <div class="showed-content">
                <img src="images/omo.jpeg" alt="">
              </div>
            </div>
          </a>
        </div>
        ...
        <div class="col-lg-3 col-sm-6">
          <a href="#">
            <div class="item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.6s">
              <div class="hidden-content">
                <h4>Embe</h4>
                <p>Azam embe sweet juice</p>
              </div>
              <div class="showed-content">
                <img src="images/embe.jpeg" alt="">
              </div>
            </div>
          </a>
        </div>
        ...
        <div class="col-lg-3 col-sm-6">
          <a href="#">
            <div class="item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.6s">
              ...
              <div class="showed-content">
                <img src="images/kijoti.jpeg" alt="">
              </div>
            </div>
          </a>
        </div>
